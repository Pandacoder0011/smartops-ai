      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-violet-600 to-cyan-400 flex items-center justify-center glow-primary mb-3">
              <Activity className="w-5 h-5 text-white" />
            </div>
            <h2 className="text-3xl font-extrabold tracking-tight text-white">Welcome back</h2>
            <p className="text-xs text-zinc-400 mt-1">Simplify your enterprise workflows with AI digital assistance.</p>
          </div>
          ...
          <div className="w-full">
            {import.meta.env.VITE_GOOGLE_CLIENT_ID ? (
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-lg bg-white/5 border border-white/5 hover:bg-white/10 hover:border-violet-500/20 text-zinc-200 text-xs font-semibold shadow-sm flex items-center justify-center gap-2 transition-all cursor-pointer h-[40px]"
              >
